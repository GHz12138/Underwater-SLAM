...
public:
    ...
    void GrabDepthData(const DepthData &pressureMeasurement);
...
protected:
    ...
    std::list<DepthData> mlQueueDepthData;
    ...
    std::vector<DepthData> mvDepthFromLastKF;

    // Vector of Pressure measurements from previous to current frame
    std::vector<DepthData> mvDepthFromLastFrame;
