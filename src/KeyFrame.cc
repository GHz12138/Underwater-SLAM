...
KeyFrame::KeyFrame():
        ...
        NLeft(0),NRight(0), mnNumberOfOpt(0), mbHasVelocity(false), mpKFDepth(NULL)
{
...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mvKeysRight(F.mvKeysRight), NLeft(F.Nleft), NRight(F.Nright), mTrl(F.GetRelativePoseTrl()), mnNumberOfOpt(0), mbHasVelocity(false), mvDepthBetweenKF(F.mvDepthBetweenKF), mpKFDepth(NULL)
{
    mnId=nNextId++;
